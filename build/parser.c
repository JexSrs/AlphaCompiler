...
#include "../Compiler/phase3/phase3.h"
...
static const yytype_int16 yyrline[] =
{
     ...
     720,   778,   794,   803,   812,   835,   836,   839,   844,   868,
     879,   884,   891,   905,   919,   938,   963,   974,   991,  1011,
    1015,  1029,  1051,  1051,  1061,  1069,  1081,  1091,  1114,  1124,
    1134,  1141,  1148,  1169,  1174,  1182,  1187,  1192,  1199,  1210,
    1222,  1227,  1248,  1258,  1266,  1280,  1290,  1300,  1316,  1323,
    1345,  1371,  1379,  1385,  1409,  1435,  1447
};
#endif
...
#line 844 "Compiler/parser.y"
                                                                    ...
                                                                    if(existsLibFunc((char*) (yyvsp[-1].exprValue)->sym->value.funcVal->name))
																	...
																	if((yyvsp[0].methodCall)->method) {
																		...
																		print(getStringValueQuad(tmp, 0));
																		tmp->prev = self;
																		print("1F");
																		self->next = tmp;
...
#line 2609 "build/parser.c"
    break;

  case 68: /* objectdef: openBracket indexed closeBracket  */
#line 991 "Compiler/parser.y"
                                                                        {
...
#line 2632 "build/parser.c"
    break;

  case 69: /* indexed: indexedelem  */
#line 1011 "Compiler/parser.y"
                                                                                                {
 															print("indexed indexedelem");
 															(yyval.exprValue) = (yyvsp[0].exprValue);
 														}
#line 2641 "build/parser.c"
    break;

  case 70: /* indexed: indexed comma indexedelem  */
#line 1015 "Compiler/parser.y"
                                                                                        {
...
#line 2683 "build/parser.c"
    break;

  case 72: /* $@6: %empty  */
#line 1051 "Compiler/parser.y"
                          { scopeOps(INCREASE); }
#line 2689 "build/parser.c"
    break;
...
#line 2780 "build/parser.c"
    break;

  case 79: /* funcBlockStart: %empty  */
#line 1124 "Compiler/parser.y"
                {
...
#line 2793 "build/parser.c"
    break;

  case 80: /* funcBlockEnd: %empty  */
#line 1134 "Compiler/parser.y"
                {
 					print("funcBlockEnd");
 					activeLoops = popLoopCounter();
 					print("funcBlockEnd");
 				}
#line 2803 "build/parser.c"
    break;
...
#line 2835 "build/parser.c"
    break;

  case 83: /* const: NUMBER  */
#line 1169 "Compiler/parser.y"
                                                {
 									print("const NUMBER");
 									(yyval.exprValue) = newExprConstNumber((yyvsp[0].numVal));
 									print("const NUMBER");
 								}
#line 2845 "build/parser.c"
    break;
...
#line 2858 "build/parser.c"
    break;

  case 85: /* const: NIL  */
#line 1182 "Compiler/parser.y"
                                                        {
			 						print("const NIL");
			 						(yyval.exprValue) = newExprNil();
			 						print("const NIL");
			 					}
#line 2868 "build/parser.c"
    break;
...
#line 2904 "build/parser.c"
    break;

  case 89: /* idlist: idlist comma ID  */
#line 1210 "Compiler/parser.y"
                                                {
...
#line 2921 "build/parser.c"
    break;

  case 90: /* idlist: %empty  */
#line 1222 "Compiler/parser.y"
                                                { print("idlist /*empty*/"); }
#line 2927 "build/parser.c"
    break;
...
#line 2951 "build/parser.c"
    break;

  case 92: /* elsePrefix: ELSE  */
#line 1248 "Compiler/parser.y"
                        {
...
#line 2964 "build/parser.c"
    break;

  case 93: /* ifstmt: ifPrefix stmt  */
#line 1258 "Compiler/parser.y"
                                                        {
...
#line 3003 "build/parser.c"
    break;

  case 96: /* loopEnd: %empty  */
#line 1290 "Compiler/parser.y"
                {
 				print("loopEnd");
...
#line 3065 "build/parser.c"
    break;

  case 100: /* whilestmt: whileStart whileCond loopstmt  */
#line 1345 "Compiler/parser.y"
                                                {
...
#line 3090 "build/parser.c"
    break;

  case 101: /* N: %empty  */
#line 1371 "Compiler/parser.y"
                {
			print("N");
...
#line 3103 "build/parser.c"
    break;

  case 102: /* M: %empty  */
#line 1379 "Compiler/parser.y"
                {
 			print("M");
 			(yyval.intVal) = nextQuadLabel();
 			print("M");
 		}
#line 3113 "build/parser.c"
    break;

  case 103: /* forPrefix: FOR openPar elist M semicolon expr semicolon  */
#line 1385 "Compiler/parser.y"
                                                                {
...
#line 3167 "build/parser.c"
    break;

  case 105: /* returnstmt: RETURN semicolon  */
#line 1435 "Compiler/parser.y"
                                                {
...
#line 3213 "build/parser.c"
    break;


#line 3217 "build/parser.c"
